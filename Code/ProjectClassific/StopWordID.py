def get_stop():
    stopwords=['ada', 'adalah', 'adanya', 'adapun', 'agak', 'agaknya', 'agar', 'akan', 'akankah', 'akhir', 'akhiri', 'akhirnya',
     ...
     'walau', 'walaupun', 'wong', 'yaitu', 'yakin', 'yakni', 'yang', 'program', 'studi','uin','syarif','jakarta', 'selatan', 'rancang', 'bangun', 'pengkajian', 'penerapan', 'sms', 'pengenalan', 'badan', 'teknologi', 'surat', 'rumah', 'sakit', 'barang']
